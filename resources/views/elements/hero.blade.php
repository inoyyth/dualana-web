    ...
    <div class="hero-copy reveal">
      ...
      @if($banner && isset($banner['data'][0]))
        ...
        <div class="hero-actions">
          @if(isset($banner['data'][0]['acf']['banner_cta_1_link']) && isset($banner['data'][0]['acf']['banner_cta_1_label']))
          ...
          @endif
          @if(isset($banner['data'][0]['acf']['banner_cta_2_link']) && isset($banner['data'][0]['acf']['banner_cta_2_label']))
